...
### Both people I conversed with determined that my data visualization is meant to depict trends in cases of H.I.V diagnosis for different modes of transmission, and instantly determined that "MSM" was consistently highest. However, there was confusion regarding the meaning of the "undetermined" mode of transmission; while I could not change the mode's label, I included a brief explanation to mitigate the confusion. 
